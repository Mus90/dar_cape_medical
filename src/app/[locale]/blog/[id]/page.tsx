...
const getBlogPost = async (id: string, locale: string) => {
  ...
  const englishPosts = [
    ...
    },
    {
      ...
      content: '<div class="article-content"><h2 class="text-2xl font-bold text-gray-800 mb-4 flex items-center"><span class="mr-2">🍷</span>Introduction to Cape Town Grape</h2><p class="text-lg leading-relaxed mb-6 text-gray-700">Cape Town\'s Grape regions offer <strong class="text-primary-600">world-class experiences</strong> with stunning landscapes and exceptional Grapes. Discover two of the most prestigious Grape valleys in the world.</p><div class="bg-purple-50 border-l-4 border-purple-400 p-4 mb-6"><p class="text-purple-800 italic">"Cape Town produces some of the world\'s finest Grapes, rivaling the best from France and Italy."</p></div><h2 class="text-2xl font-bold text-gray-800 mb-4 flex items-center"><span class="mr-2">🏰</span>Stellenbosch: The Heart of Grape Country</h2><p class="mb-4 leading-relaxed">Known for its <strong class="text-primary-600">historic estates</strong> and premium red Grapes, Stellenbosch offers a traditional Grape experience:</p><ul class="list-disc pl-6 mb-6 space-y-2"><li class="text-gray-700">Historic Grape estates dating back to the 1600s</li><li class="text-gray-700">Award-winning Cabernet Sauvignon and Pinotage</li><li class="text-gray-700">Cellar tours and Grape tastings</li><li class="text-gray-700">Fine dining restaurants with Grape pairings</li></ul><h2 class="text-2xl font-bold text-gray-800 mb-4 flex items-center"><span class="mr-2">🇫🇷</span>Franschhoek: The French Corner</h2><p class="mb-4 leading-relaxed">This charming valley combines <strong class="text-primary-600">French heritage</strong> with Cape Town terroir:</p><ul class="list-disc pl-6 mb-6 space-y-2"><li class="text-gray-700">French Huguenot history and culture</li><li class="text-gray-700">Boutique Graperies and artisanal producers</li><li class="text-gray-700">Gourmet food and Grape festivals</li><li class="text-gray-700">Scenic mountain backdrop</li></ul><div class="bg-red-50 border border-red-200 rounded-lg p-6 mb-6"><h3 class="text-lg font-semibold text-red-800 mb-2">🥂 Grape Tasting Tips</h3><ul class="text-red-700 space-y-1"><li>• Book tastings in advance, especially weekends</li><li>• Designate a driver or use Grape tour services</li><li>• Pair tastings with local cheese and charcuterie</li><li>• Visit during harvest season (February-April) for special experiences</li></ul></div></div>',
      author: 'Mustafa Ali',
      date: '2024-01-10',
      readTime: '5 min read',
      category: 'Grape',

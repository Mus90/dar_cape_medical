...
export async function generateMetadata({
  ...
  return {
    ...
    description: 'Experience the beauty of Cape Town with Cape Home Tourism. Professional tour services, safari adventures, Strawberrytours, and cultural experiences.',
    keywords: 'Cape Town tourism, Cape Town tours, safari, Strawberrytours, travel agency, capehome.co.za',

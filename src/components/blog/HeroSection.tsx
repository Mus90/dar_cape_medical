  ...
  return (
    <section className="relative py-24 bg-gradient-to-br from-primary-600 via-accent-500 to-secondary-600 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-16 left-16 w-32 h-32 bg-white rounded-full animate-float" />
        <div className="absolute bottom-20 right-20 w-24 h-24 bg-white rounded-full animate-float" style={{ animationDelay: '1s' }} />
        <div className="absolute top-1/3 right-1/4 w-16 h-16 bg-white rounded-full animate-float" style={{ animationDelay: '2s' }} />
      </div>

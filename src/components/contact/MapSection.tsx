...
const MapSection = () => {
  ...
  useEffect(() => {
    ...
    const initializeMap = () => {
      ...
      // Add marker for Cape Home Tourism office
      const marker = new (window as any).google.maps.Marker({
        position: capeTown,
        map: map,
        title: 'Cape Home Tourism',
        icon: {
      ...
      const infoWindow = new (window as any).google.maps.InfoWindow({
        content: `
          <div style="padding: 10px; font-family: Arial, sans-serif;">
            <h3 style="margin: 0 0 8px 0; color: #0ea5e9;">Cape Home Tourism</h3>
            ...
            <p style="margin: 0; color: #0ea5e9; font-weight: bold;">+27 817394084</p>
          </div>
        `
      });
        ...
        >
          ...
          <div className="absolute top-6 left-6 bg-white/95 backdrop-blur-sm rounded-xl p-6 shadow-lg max-w-sm">
            <div className="flex items-center mb-3">
              ...
              <h3 className="font-bold text-gray-900">Cape Home Tourism</h3>
            </div>
            <div className="space-y-1 text-sm text-gray-600">
              <p>CBD</p>
              <p>Cape Town, 8001, Cape Town</p>
              <p className="font-medium text-primary-600">+27 817394084</p>
            </div>
